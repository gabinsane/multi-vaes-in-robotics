...
class MultimodalVAEInfer():
    ...
    def __init__(self, model, model_config):
        ...
        self.model = MultimodalVAE.load_from_checkpoint(self.path, cfg=self.model.config, feature_dims=self.datamod.get_dataset_class().feature_dims)
    ...
    def get_config(self):
        ...
        assert os.path.exists(self.config_path), "Provided config path does not exist!"
        cfg = Config(self.config_path, eval_only=True)
        return cfg
